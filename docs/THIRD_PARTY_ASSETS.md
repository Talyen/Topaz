...
| `Assets/Topaz/VisualStudy/Decals/Ground Wear.mat` | Unity URP package `Runtime/Materials/Decal.mat` | [Unity Companion License](https://unity.com/legal/licenses/unity-companion-license) | Yes, in connection with this Unity project under the package license | Cloned from Unity's decal material and assigned a project-generated `Ground Wear.png` texture. Unity retains rights to its material and shader graph; the PNG is Topaz-authored. |
| `Assets/Topaz/VisualStudy/Shaders/Orthographic*DepthOfField.shader` | Unity URP package `Shaders/PostProcessing/{Gaussian,Bokeh}DepthOfField.shader` | [Unity Companion License](https://unity.com/legal/licenses/unity-companion-license) for Unity-derived CoC logic | Yes, in connection with this Unity project under the package license | Minimal orthographic depth conversion and Bokeh mask dither; blur and composite passes reference the installed Unity shaders via `UsePass`. Original Unity copyright and license are noted in each adapter. |
