...
| Connected regions and scene transitions | [scene list in Build Profiles](https://docs.unity3d.com/6000.6/Documentation/Manual/build-profile-scene-list.html), [SceneManager.LoadSceneAsync](https://docs.unity3d.com/6000.6/Documentation/ScriptReference/SceneManagement.SceneManager.LoadSceneAsync.html), [SceneManager.UnloadSceneAsync](https://docs.unity3d.com/6000.6/Documentation/ScriptReference/SceneManagement.SceneManager.UnloadSceneAsync.html) | The [first expedition clearing](studies/EXPEDITION_STUDY.md) tests additive travel with a stable region ID. Keep authored scene identity and save state separate; measure transitions before adding broader content-loading infrastructure. |
