...
namespace Topaz.Editor
{
    ...
    public static class VisualStudySetup
    {
        ...
        const string ProfileFolder = "Assets/Topaz/Presentation/Graphics/Profiles";
        ...
        const string PostProcessDataPath =
            "Assets/Topaz/Presentation/Graphics/OrthographicPostProcessData.asset";
        ...
        public static void Configure()
        {
            ...
            UnityEngine.Object globalSettings = AssetDatabase.LoadMainAssetAtPath(
                "Assets/Topaz/Presentation/Rendering/Settings/UniversalRenderPipelineGlobalSettings.asset");
            ...
            if (session != null) Ref(session, "look", controller);
        ...
        static void AddLantern(Transform parent)
        {
            ...
            if (ember == null)
            {
                EnsureFolder("Assets/Topaz/Presentation/Graphics/Materials");
                ...
                AssetDatabase.CreateAsset(ember, "Assets/Topaz/Presentation/Effects/Materials/Lantern Ember.mat");
            }
