...
namespace Topaz.Editor
{
    ...
    {
        const string SampleScene = "Assets/Topaz/World/Scenes/SampleScene.unity";
        const string BootstrapScene = "Assets/Topaz/World/Scenes/Bootstrap.unity";
        ...
        {
            string path = $"Assets/Topaz/Build/Profiles/{profileName}.asset";
