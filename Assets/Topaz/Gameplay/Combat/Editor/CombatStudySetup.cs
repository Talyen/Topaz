...
namespace Topaz.Editor
{
    ...
    public static class CombatStudySetup
    {
        ...
        const string DefinitionPath = "Assets/Topaz/Gameplay/Combat/Definitions";
        const string MaterialPath = "Assets/Topaz/Gameplay/Combat/Materials";
        const string NavigationPath = "Assets/Topaz/World/Home/Navigation/PracticeNavMesh.asset";
        ...
        public static void Configure()
        {
            ...
            EnsureFolder("Assets/Topaz/World/Home/Navigation");
            EnsureAttackBinding();
