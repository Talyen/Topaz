...
namespace Topaz.Editor
{
    ...
    public static class ExpeditionStudySetup
    {
        ...
        const string Root = "Assets/Topaz/World/Expedition";
        ...
        public static void Configure()
        {
            ...
            Material guardianMaterial = CloneMaterial("Guardian Skeleton",
                "Assets/Topaz/Presentation/Art/Materials/Skeleton.mat", new Color(.94f, .76f, .48f));
            ...
            foreach (Vector3 position in obstacles)
                AttachModel(decoration, "Forest/Models/Rock_3_B_Color1.fbx", forest,
        ...
        static void AddTree(Transform parent, Material material, Vector3 position, float height) =>
            AttachModel(parent, "Forest/Models/Tree_4_B_Color1.fbx", material,
